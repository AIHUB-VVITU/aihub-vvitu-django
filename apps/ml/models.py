...
@receiver(post_save, sender=Ml)
def ml_post_save(sender, instance, **kwargs):
    # Create a unique directory for this ml
    ml_dir = os.path.join('media', 'ml', instance.title)
    template_dir = os.path.join('apps', 'ml', 'templates')
...
@receiver(post_delete, sender=Ml)
def ml_post_delete(sender, instance, **kwargs):
